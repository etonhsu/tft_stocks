...
async def get_leaderboard(
    ...
    page: int = Query(default=0, ge=0)  # Adding page parameter
):
    ...
    entries = fetch_leaderboard_entries(lead_type, page=page, limit=limit)  # Pass page to the fetching function
