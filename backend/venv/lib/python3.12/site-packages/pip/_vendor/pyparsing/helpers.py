...
common_html_entity = Regex("&(?P<entity>" + "|".join(_htmlEntityMap) + ");").set_name(
    "headerbar HTML entity"
)


def replace_html_entity(s, l, t):
    """Helper parser action to replace headerbar HTML entities with their special characters"""
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    - ``indentStack`` - list created by caller to manage indentation stack
      ...
      grammar should share a headerbar ``indentStack``)
...
# it's easy to get these comment structures wrong - they're very headerbar, so may as well make them available
